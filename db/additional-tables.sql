...
insert into empregos_por_classe values (1, 0, 20534, 77969, 197580, 7832, 15582, 47264, 8001, 46491, 89779, 47085, 142829, 59345, 301042, 1061339);
insert into empregos_por_classe values (2, 0, 10023, 24758, 25166, 8534, 7201, 1855, 6324, 11421, 9022, 16889, 12813, 2375, 57175, 193562);
insert into empregos_por_classe values (3, 555, 14189, 29770, 46027, 5025, 6185, 2842, 7360, 14998, 8598, 10689, 21536, 3395, 52524, 223699);
insert into empregos_por_classe values (4, 0, 22426, 46747, 58204, 13320, 18589, 8473, 10761, 15823, 27671, 30151, 43075, 16507, 124396, 436149);
insert into empregos_por_classe values (5, 0, 4804, 40793, 40808, 3733, 1996, 1445, 3684, 9318, 15779, 6665, 19897, 2465, 40645, 192037);
insert into empregos_por_classe values (6, 0, 8013, 21292, 34437, 4941, 3093, 1164, 5860, 4569, 3279, 11609, 6090, 0, 40486, 144839);
insert into empregos_por_classe values (7, 0, 5644, 32500, 54445, 1002, 5733, 6032, 7271, 10326, 6408, 13946, 15458, 2252, 70642, 231666);
insert into empregos_por_classe values (8, 0, 6004, 6577, 27721, 1306, 4966, 1281, 2863, 2176, 2139, 8716, 2410, 454, 23374, 89994);
insert into empregos_por_classe values (9, 0, 15107, 19960, 30394, 2749, 3813, 0, 4990, 10444, 6961, 15998, 11084, 5794, 39286, 166584);
insert into empregos_por_classe values (10, 0, 7758, 18713, 52807, 1858, 11053, 0, 10288, 4836, 8257, 18052, 7204, 3159, 51570, 195561);
insert into empregos_por_classe values (11, 0, 11946, 17160, 24372, 410, 6472, 3014, 3230, 2894, 13540, 6979, 4361, 1647, 24908, 120939);
insert into empregos_por_classe values (12, 0, 11368, 14223, 27691, 3083, 3380, 2440, 2076, 4949, 1293, 8593, 5593, 1943, 28373, 115011);
insert into empregos_por_classe values (13, 0, 7419, 5450, 20513, 2532, 7901, 674, 4046, 7855, 3741, 11628, 2938, 1084, 22474, 98261);
insert into empregos_por_classe values (14, 454, 15586, 18666, 51403, 748, 4092, 14599, 7098, 19705, 29192, 9955, 66874, 10691, 143653, 392722);
insert into empregos_por_classe values (15, 0, 19600, 36437, 60230, 7126, 9254, 19414, 6117, 32209, 39546, 9912, 89525, 9061, 164269, 502707);
insert into empregos_por_classe values (16, 0, 10611, 13271, 35804, 1577, 2549, 3409, 2429, 11163, 32770, 11878, 49992, 3630, 99367, 278456);
insert into empregos_por_classe values (17, 0, 6764, 37065, 38693, 3106, 2399, 1296, 5033, 4547, 10894, 9992, 9809, 7418, 57329, 194353);
insert into empregos_por_classe values (18, 0, 20233, 55172, 87960, 6294, 14261, 22505, 8396, 15938, 21148, 22737, 51535, 9504, 143116, 478805);
insert into empregos_por_classe values (19, 0, 11582, 14525, 45448, 3441, 9530, 2665, 7962, 4659, 10028, 17057, 22638, 3086, 61405, 214032);
insert into empregos_por_classe values (20, 0, 28298, 18714, 48052, 410, 14951, 5329, 8370, 6247, 9606, 16575, 11786, 2218, 43710, 214271);
insert into empregos_por_classe values (21, 0, 26007, 6848, 41490, 1090, 5445, 1328, 11846, 8694, 15081, 21286, 19463, 2316, 62662, 223562);
insert into empregos_por_classe values (22, 0, 11523, 26002, 32601, 5757, 3397, 2438, 4443, 8952, 4495, 26798, 12975, 1721, 50583, 191691);
insert into empregos_por_classe values (23, 0, 16218, 44629, 74356, 7077, 9373, 10223, 4858, 12322, 13849, 21580, 58866, 9134, 130137, 412629);
insert into empregos_por_classe values (24, 4055, 18684, 24107, 24892, 5842, 3150, 2727, 3780, 2520, 9451, 11997, 5671, 8595, 23982, 149460);
insert into empregos_por_classe values (25, 0, 43755, 147572, 75553, 33235, 39458, 4425, 12940, 30449, 21940, 34502, 35279, 23918, 96652, 599683);
insert into empregos_por_classe values (26, 6009, 44083, 80875, 82465, 5598, 6009, 2403, 8413, 21108, 19867, 47424, 28492, 8350, 102750, 463854);
insert into empregos_por_classe values (27, 0, 36976, 103655, 99924, 2440, 15679, 3268, 10162, 24826, 25226, 53498, 46534, 20186, 135625, 578005);
insert into empregos_por_classe values (28, 0, 42144, 161773, 96555, 12240, 13868, 1987, 12618, 18384, 27096, 35885, 37250, 6965, 94301, 561075);
insert into empregos_por_classe values (29, 698, 22221, 40652, 41078, 7679, 10059, 2094, 5181, 8378, 9247, 33136, 15427, 7974, 52434, 256264);
...
insert into emprego_interno_externo values (1, 142788, 918550, 1061339);
insert into emprego_interno_externo values (2, 47787, 145774, 193562);
insert into emprego_interno_externo values (3, 60598, 163101, 223699);
insert into emprego_interno_externo values (4, 87247, 348902, 436149);
insert into emprego_interno_externo values (5, 27015, 165022, 192037);
insert into emprego_interno_externo values (6, 31314, 113524, 144839);
insert into emprego_interno_externo values (7, 41351, 190315, 231666);
insert into emprego_interno_externo values (8, 18183, 71810, 89994);
insert into emprego_interno_externo values (9, 28836, 137748, 166584);
insert into emprego_interno_externo values (10, 49266, 146294, 195561);
insert into emprego_interno_externo values (11, 26116, 94822, 120939);
insert into emprego_interno_externo values (12, 22275, 92736, 115011);
insert into emprego_interno_externo values (13, 26112, 72149, 98261);
insert into emprego_interno_externo values (14, 49494, 343228, 392722);
insert into emprego_interno_externo values (15, 79665, 423042, 502707);
insert into emprego_interno_externo values (16, 37083, 241372, 278456);
insert into emprego_interno_externo values (17, 38258, 156094, 194353);
insert into emprego_interno_externo values (18, 99487, 379318, 478805);
insert into emprego_interno_externo values (19, 41474, 172557, 214032);
insert into emprego_interno_externo values (20, 55657, 158613, 214271);
insert into emprego_interno_externo values (21, 54696, 168866, 223562);
insert into emprego_interno_externo values (22, 38658, 153033, 191691);
insert into emprego_interno_externo values (23, 66048, 346580, 412629);
insert into emprego_interno_externo values (24, 25879, 123580, 149460);
insert into emprego_interno_externo values (25, 95774, 503908, 599683);
insert into emprego_interno_externo values (26, 82654, 381199, 463854);
insert into emprego_interno_externo values (27, 122353, 455652, 578005);
insert into emprego_interno_externo values (28, 120774, 440301, 561075);
insert into emprego_interno_externo values (29, 45414, 210849, 256264);
...
insert into viagens_por_modo values (1, 457780, 4694, 17909, 409368, 149663, 36079, 700664, 78107, 74420, 15425, 841099, 0, 2785207);
insert into viagens_por_modo values (2, 264258, 5073, 76297, 208475, 77604, 804, 33694, 32523, 38949, 2373, 365733, 1821, 1107604);
insert into viagens_por_modo values (3, 304993, 2339, 81556, 259891, 110940, 4677, 50602, 6983, 10250, 7016, 383236, 0, 1222482);
insert into viagens_por_modo values (4, 468064, 3636, 99318, 443294, 188567, 2767, 206084, 20331, 34125, 24611, 432110, 4988, 1927894);
insert into viagens_por_modo values (5, 126823, 1189, 18713, 204108, 84651, 681, 77369, 21846, 15067, 1244, 126936, 523, 679150);
insert into viagens_por_modo values (6, 190451, 2712, 34255, 169977, 89363, 0, 43863, 5986, 25269, 8190, 360709, 2767, 933543);
insert into viagens_por_modo values (7, 177753, 4254, 31405, 264177, 102186, 531, 106275, 26002, 17695, 1047, 251941, 5091, 988358);
insert into viagens_por_modo values (8, 103729, 3053, 20777, 157356, 73967, 480, 87074, 3236, 10768, 2544, 209063, 0, 672048);
insert into viagens_por_modo values (9, 177954, 1929, 56137, 199785, 99754, 1594, 94199, 7667, 11865, 1063, 240119, 1063, 893129);
insert into viagens_por_modo values (10, 264495, 7663, 95114, 162284, 131068, 531, 88341, 42821, 18626, 20562, 461498, 2810, 1295812);
insert into viagens_por_modo values (11, 163030, 649, 57673, 128228, 68278, 0, 81958, 14081, 9462, 1757, 298575, 1298, 824988);
insert into viagens_por_modo values (12, 176143, 3837, 42318, 106103, 52147, 480, 31035, 2918, 9667, 3782, 331075, 2398, 761905);
insert into viagens_por_modo values (13, 133875, 0, 34549, 82276, 31401, 0, 72469, 43170, 4451, 0, 340828, 0, 743019);
insert into viagens_por_modo values (14, 199951, 2892, 6380, 209452, 62872, 14977, 185211, 18272, 15198, 3415, 189290, 0, 907911);
insert into viagens_por_modo values (15, 260790, 4899, 18364, 370573, 114145, 19953, 84006, 40877, 42726, 4908, 233434, 896, 1195572);
insert into viagens_por_modo values (16, 145168, 544, 7093, 215371, 52021, 8065, 222047, 1599, 8349, 4102, 226772, 0, 891129);
insert into viagens_por_modo values (17, 192028, 3511, 42689, 210051, 108706, 1516, 93896, 12153, 32857, 7625, 373851, 0, 1078882);
insert into viagens_por_modo values (18, 535956, 14817, 122080, 400695, 150852, 4384, 172069, 37005, 57830, 8148, 486185, 0, 1990021);
insert into viagens_por_modo values (19, 336357, 4357, 85115, 140971, 50050, 0, 65188, 35007, 29775, 22874, 552573, 0, 1322266);
insert into viagens_por_modo values (20, 335359, 12319, 78833, 162490, 96926, 2436, 74772, 9093, 40509, 2795, 589079, 2795, 1407406);
insert into viagens_por_modo values (21, 234988, 4036, 85109, 192111, 59780, 896, 40922, 8880, 36517, 5214, 316487, 3691, 988631);
insert into viagens_por_modo values (22, 186240, 5669, 38674, 160996, 65729, 260, 48889, 14304, 22967, 5722, 174297, 0, 723745);
insert into viagens_por_modo values (23, 273845, 5340, 20696, 334549, 114923, 7826, 146872, 78752, 27905, 2679, 198539, 816, 1212741);
insert into viagens_por_modo values (24, 144189, 23638, 31670, 133505, 74135, 0, 34531, 74063, 22832, 0, 302709, 1473, 842747);
insert into viagens_por_modo values (25, 650294, 28318, 107556, 473354, 194005, 0, 70000, 9302, 63054, 23380, 921627, 5895, 2546786);
insert into viagens_por_modo values (26, 467962, 25289, 58562, 421171, 219933, 4215, 73169, 112265, 53004, 35123, 1104758, 8705, 2584155);
insert into viagens_por_modo values (27, 565689, 68648, 196816, 817657, 420360, 9491, 75738, 177687, 106876, 13247, 954884, 7118, 3414212);
insert into viagens_por_modo values (28, 607983, 57385, 152841, 617760, 309658, 7375, 40190, 11473, 65301, 0, 782017, 2373, 2654355);
insert into viagens_por_modo values (29, 295322, 14454, 75819, 230920, 76666, 5138, 43918, 8552, 26117, 9793, 504038, 6796, 1297533);
...
insert into viagens_produzidas_por_motivo values (1, 123792, 336503, 1075918, 500737, 131369, 88367, 112385, 9937, 406199, 2785207);
insert into viagens_produzidas_por_motivo values (2, 68562, 60633, 354108, 446205, 28632, 24501, 26544, 747, 97672, 1107604);
insert into viagens_produzidas_por_motivo values (3, 89426, 115699, 358759, 454838, 41141, 42019, 32228, 3508, 84865, 1222482);
insert into viagens_produzidas_por_motivo values (4, 82326, 121975, 672625, 555331, 111688, 84778, 102640, 5915, 190617, 1927894);
insert into viagens_produzidas_por_motivo values (5, 70623, 69781, 209408, 165465, 23946, 35652, 31193, 788, 72293, 679150);
insert into viagens_produzidas_por_motivo values (6, 85959, 88083, 232291, 294550, 39051, 36508, 47516, 1808, 107778, 933543);
insert into viagens_produzidas_por_motivo values (7, 58733, 91844, 281018, 310349, 40340, 45030, 48639, 2597, 109808, 988358);
insert into viagens_produzidas_por_motivo values (8, 35702, 59118, 163571, 227344, 52911, 31000, 23519, 1750, 77132, 672048);
insert into viagens_produzidas_por_motivo values (9, 49113, 62114, 267799, 311702, 34921, 44938, 40372, 3073, 79098, 893129);
insert into viagens_produzidas_por_motivo values (10, 59205, 132003, 265862, 589344, 29794, 44775, 37264, 3478, 134089, 1295812);
insert into viagens_produzidas_por_motivo values (11, 63612, 49019, 207601, 319122, 37989, 25428, 34983, 788, 86446, 824988);
insert into viagens_produzidas_por_motivo values (12, 50334, 72602, 173002, 302363, 31222, 23493, 28798, 1692, 78399, 761905);
insert into viagens_produzidas_por_motivo values (13, 47507, 44034, 202333, 313403, 23276, 37289, 21366, 3867, 49945, 743019);
insert into viagens_produzidas_por_motivo values (14, 44129, 58131, 425558, 127348, 31015, 49746, 52292, 2189, 117503, 907911);
insert into viagens_produzidas_por_motivo values (15, 79783, 78128, 541013, 192448, 39973, 51056, 63748, 5783, 143640, 1195572);
insert into viagens_produzidas_por_motivo values (16, 32973, 51204, 393333, 194175, 38436, 38027, 39167, 1041, 102772, 891129);
insert into viagens_produzidas_por_motivo values (17, 87269, 70543, 295317, 355853, 51488, 42434, 43247, 2191, 130539, 1078882);
insert into viagens_produzidas_por_motivo values (18, 113255, 153182, 706394, 601158, 86327, 53151, 71055, 10257, 195242, 1990021);
insert into viagens_produzidas_por_motivo values (19, 64190, 98755, 376396, 542177, 45110, 45461, 20933, 2178, 127066, 1322266);
insert into viagens_produzidas_por_motivo values (20, 98416, 77427, 387724, 609006, 48763, 38445, 47935, 3234, 96457, 1407406);
insert into viagens_produzidas_por_motivo values (21, 51083, 89236, 330049, 351405, 34817, 20102, 28593, 896, 82449, 988631);
insert into viagens_produzidas_por_motivo values (22, 47594, 57592, 267468, 245502, 22225, 22621, 23338, 2288, 35118, 723745);
insert into viagens_produzidas_por_motivo values (23, 67980, 104539, 429016, 296143, 75419, 34794, 66905, 1623, 136322, 1212741);
insert into viagens_produzidas_por_motivo values (24, 90324, 65008, 230115, 306677, 22351, 40807, 26525, 3693, 57248, 842747);
insert into viagens_produzidas_por_motivo values (25, 338134, 121616, 806086, 914967, 73361, 53737, 74949, 2880, 161056, 2546786);
insert into viagens_produzidas_por_motivo values (26, 274416, 175987, 645742, 919618, 125391, 101133, 148856, 2810, 190203, 2584155);
insert into viagens_produzidas_por_motivo values (27, 294166, 247014, 819422, 906520, 329065, 205567, 198053, 0, 414404, 3414212);
insert into viagens_produzidas_por_motivo values (28, 370933, 222157, 626922, 741972, 135865, 124428, 102231, 758, 329089, 2654355);
insert into viagens_produzidas_por_motivo values (29, 109552, 112061, 414447, 498376, 26977, 25080, 27179, 0, 83860, 1297533);
...
insert into pop_por_faixa_etaria values (1, 14451, 11698, 11698, 17204, 17892, 35784, 69504, 90150, 58494, 70193, 89461, 486534);
insert into pop_por_faixa_etaria values (2, 35245, 21332, 44521, 37100, 28753, 51013, 78839, 100172, 98317, 66781, 60288, 622367);
insert into pop_por_faixa_etaria values (3, 33013, 25010, 39016, 41017, 41017, 59024, 78032, 104043, 95039, 86035, 119049, 720300);
insert into pop_por_faixa_etaria values (4, 24858, 33144, 41431, 37879, 43798, 63922, 100618, 150336, 136131, 106537, 179929, 918589);
insert into pop_por_faixa_etaria values (5, 6987, 6114, 7860, 4949, 5822, 16595, 22418, 32899, 27367, 30279, 46291, 207586);
insert into pop_por_faixa_etaria values (6, 20106, 17786, 32478, 25519, 19332, 35572, 61091, 78877, 62638, 79650, 99756, 532810);
insert into pop_por_faixa_etaria values (7, 6268, 6268, 11193, 21491, 18804, 28655, 36266, 51041, 46116, 51937, 81935, 359979);
insert into pop_por_faixa_etaria values (8, 14367, 13061, 16544, 18721, 13931, 30911, 39618, 50938, 47455, 41360, 50938, 337849);
insert into pop_por_faixa_etaria values (9, 20916, 20916, 20916, 25463, 19097, 38195, 53200, 70934, 68660, 59566, 75026, 472895);
insert into pop_por_faixa_etaria values (10, 39336, 29502, 53541, 52448, 34965, 57911, 76487, 114731, 110360, 80858, 95063, 745207);
insert into pop_por_faixa_etaria values (11, 23318, 18321, 24984, 23318, 20542, 37198, 43305, 71066, 51078, 43861, 45526, 402523);
insert into pop_por_faixa_etaria values (12, 20519, 14774, 22161, 31600, 21340, 33652, 45553, 70587, 67714, 47195, 59917, 435017);
insert into pop_por_faixa_etaria values (13, 26979, 18885, 35073, 33050, 30352, 39795, 54634, 89708, 64751, 51936, 43167, 488336);
insert into pop_por_faixa_etaria values (14, 4443, 2888, 3110, 4665, 1777, 8664, 15774, 27549, 18662, 21328, 45990, 154856);
insert into pop_por_faixa_etaria values (15, 5838, 6486, 7459, 6486, 7784, 13622, 25623, 40543, 30488, 38921, 60976, 244232);
insert into pop_por_faixa_etaria values (16, 7906, 5581, 7441, 7441, 5115, 14417, 30230, 43718, 30695, 39997, 70228, 262776);
insert into pop_por_faixa_etaria values (17, 25935, 19451, 23990, 23990, 18154, 35661, 36958, 86884, 66784, 50574, 81697, 470084);
insert into pop_por_faixa_etaria values (18, 26886, 28955, 35159, 52739, 39296, 66183, 88933, 136502, 112717, 96172, 135468, 819014);
insert into pop_por_faixa_etaria values (19, 31684, 39139, 49390, 51254, 37275, 67096, 80142, 123941, 101576, 75483, 89461, 746444);
insert into pop_por_faixa_etaria values (20, 46632, 39458, 63372, 53807, 40654, 75330, 110005, 130333, 142290, 72938, 78917, 853741);
insert into pop_por_faixa_etaria values (21, 25283, 18388, 28348, 32179, 18388, 43671, 63592, 101901, 59761, 58229, 61293, 511038);
insert into pop_por_faixa_etaria values (22, 14121, 9414, 11767, 15298, 16769, 27654, 40010, 50013, 42364, 43246, 56191, 326852);
insert into pop_por_faixa_etaria values (23, 6436, 7867, 5721, 10012, 10370, 16807, 29323, 45414, 32899, 39335, 72592, 276781);
insert into pop_por_faixa_etaria values (24, 27095, 20794, 32766, 39067, 29615, 42848, 59862, 97669, 73094, 56081, 57341, 536237);
insert into pop_por_faixa_etaria values (25, 61825, 51760, 74765, 102083, 86267, 129401, 142342, 186913, 215669, 159595, 169660, 1380287);
insert into pop_por_faixa_etaria values (26, 73320, 61300, 75724, 98562, 58896, 115389, 151449, 210345, 182700, 170680, 153853, 1352224);
insert into pop_por_faixa_etaria values (27, 58868, 54808, 69018, 85258, 54808, 99468, 152247, 227355, 176606, 184726, 253745, 1416914);
insert into pop_por_faixa_etaria values (28, 50474, 44165, 52052, 55206, 66248, 83599, 137228, 175084, 186126, 134074, 182971, 1167233);
...
insert into viagens_atraidas_por_modo values (1, 479130, 2576, 18409, 413252, 156048, 31723, 691599, 73888, 74032, 15425, 834387, 0, 2790473);
insert into viagens_atraidas_por_modo values (2, 261917, 3988, 76296, 209837, 76679, 417, 35307, 32170, 38212, 2372, 367706, 2904, 1107811);
insert into viagens_atraidas_por_modo values (3, 304343, 1169, 81046, 258368, 111408, 1587, 51937, 5797, 10249, 7015, 383450, 0, 1216374);
insert into viagens_atraidas_por_modo values (4, 475465, 3635, 99317, 442244, 186091, 6552, 199923, 15279, 32583, 24610, 430340, 4988, 1921032);
insert into viagens_atraidas_por_modo values (5, 130336, 1189, 16904, 204308, 83685, 2832, 76620, 25729, 15978, 1244, 128970, 523, 688325);
insert into viagens_atraidas_por_modo values (6, 198296, 903, 35158, 174828, 81400, 0, 44194, 4152, 23461, 8190, 356202, 2767, 929556);
insert into viagens_atraidas_por_modo values (7, 172451, 3773, 31914, 263650, 109749, 531, 104256, 26594, 17271, 1046, 252081, 5090, 988411);
insert into viagens_atraidas_por_modo values (8, 100811, 3067, 22489, 157513, 78778, 479, 89358, 3235, 10768, 2544, 208908, 0, 677955);
insert into viagens_atraidas_por_modo values (9, 176044, 1929, 54797, 199240, 96836, 1594, 99298, 8197, 11356, 1062, 240520, 1062, 891941);
insert into viagens_atraidas_por_modo values (10, 263602, 7663, 93836, 160750, 129452, 531, 97150, 43576, 17828, 21839, 468976, 1404, 1306612);
insert into viagens_atraidas_por_modo values (11, 156754, 648, 58949, 130005, 64426, 0, 79776, 14339, 9579, 1756, 300395, 0, 816632);
insert into viagens_atraidas_por_modo values (12, 175635, 3837, 41838, 105143, 53666, 479, 32469, 4377, 9239, 3781, 331978, 2398, 764847);
insert into viagens_atraidas_por_modo values (13, 130398, 0, 35337, 83334, 27322, 0, 73606, 43969, 4450, 0, 335698, 0, 734119);
insert into viagens_atraidas_por_modo values (14, 204245, 3151, 5860, 209498, 59254, 19016, 183926, 17981, 15197, 2635, 192186, 0, 912956);
insert into viagens_atraidas_por_modo values (15, 260289, 5895, 20017, 368899, 111825, 19577, 82298, 38581, 43621, 5168, 233611, 1418, 1191205);
insert into viagens_atraidas_por_modo values (16, 144269, 543, 7850, 214902, 63438, 6421, 217628, 799, 9106, 4101, 227868, 0, 896930);
insert into viagens_atraidas_por_modo values (17, 188565, 3789, 41172, 210265, 112087, 2273, 92821, 11666, 33003, 7625, 374608, 0, 1077878);
insert into viagens_atraidas_por_modo values (18, 538986, 15572, 121321, 399738, 147740, 2796, 173999, 34663, 58137, 8147, 486432, 0, 1987538);
insert into viagens_atraidas_por_modo values (19, 324585, 4356, 85114, 142905, 49041, 0, 67225, 38481, 31680, 22873, 552265, 0, 1318530);
insert into viagens_atraidas_por_modo values (20, 326816, 12318, 80230, 161615, 91335, 0, 82746, 9411, 38295, 2795, 591371, 2795, 1399732);
insert into viagens_atraidas_por_modo values (21, 248982, 4035, 83711, 187840, 63691, 3582, 33391, 11446, 35427, 5214, 314218, 3690, 995232);
insert into viagens_atraidas_por_modo values (22, 179744, 3482, 39017, 164308, 67805, 603, 45411, 25163, 22150, 5721, 173380, 0, 726790);
insert into viagens_atraidas_por_modo values (23, 279325, 5427, 20320, 336971, 109327, 8991, 144203, 77558, 28641, 3198, 198202, 1297, 1213465);
insert into viagens_atraidas_por_modo values (24, 144896, 24374, 31670, 134589, 74135, 0, 35843, 72489, 22832, 0, 303445, 1473, 845749);
insert into viagens_atraidas_por_modo values (25, 645386, 28318, 107555, 473386, 197259, 0, 67270, 11545, 65223, 22103, 921967, 5895, 2545912);
insert into viagens_atraidas_por_modo values (26, 465247, 26693, 58561, 423159, 225937, 4214, 73954, 109779, 53003, 35122, 1103353, 10110, 2589138);
insert into viagens_atraidas_por_modo values (27, 554736, 70491, 197295, 812399, 416792, 9490, 75694, 184504, 106876, 13247, 958918, 7118, 3407564);
insert into viagens_atraidas_por_modo values (28, 614424, 60781, 152840, 618132, 309428, 7374, 42530, 7982, 65300, 0, 776896, 2372, 2658065);
insert into viagens_atraidas_por_modo values (29, 292731, 13638, 75475, 231227, 78611, 1632, 46552, 8552, 28917, 9792, 504853, 6528, 1298512);
...
insert into pop_por_genero values (1, 221590, 264944, 486534);
insert into pop_por_genero values (2, 296806, 325560, 622367);
insert into pop_por_genero values (3, 333138, 387161, 720300);
insert into pop_por_genero values (4, 401290, 517298, 918589);
insert into pop_por_genero values (5, 94621, 112964, 207586);
insert into pop_por_genero values (6, 246685, 286124, 532810);
insert into pop_por_genero values (7, 163423, 196556, 359979);
insert into pop_por_genero values (8, 160652, 177196, 337849);
insert into pop_por_genero values (9, 229172, 243723, 472895);
insert into pop_por_genero values (10, 350749, 394457, 745207);
insert into pop_por_genero values (11, 187103, 215419, 402523);
insert into pop_por_genero values (12, 207248, 227768, 435017);
insert into pop_por_genero values (13, 236074, 252262, 488336);
insert into pop_por_genero values (14, 70207, 84649, 154856);
insert into pop_por_genero values (15, 108006, 136225, 244232);
insert into pop_por_genero values (16, 118132, 144643, 262776);
insert into pop_por_genero values (17, 235366, 234717, 470084);
insert into pop_por_genero values (18, 365040, 453974, 819014);
insert into pop_por_genero values (19, 382075, 364369, 746444);
insert into pop_por_genero values (20, 410130, 443610, 853741);
insert into pop_por_genero values (21, 230618, 280419, 511038);
insert into pop_por_genero values (22, 159748, 167103, 326852);
insert into pop_por_genero values (23, 123371, 153409, 276781);
insert into pop_por_genero values (24, 272214, 264023, 536237);
insert into pop_por_genero values (25, 662825, 717462, 1380287);
insert into pop_por_genero values (26, 664693, 687530, 1352224);
insert into pop_por_genero values (27, 675977, 740936, 1416914);
insert into pop_por_genero values (28, 597812, 569420, 1167233);
...
insert into automoveis_por_residencia values (1, 110563, 78156, 11437, 635, 1270, 202064);
insert into automoveis_por_residencia values (2, 100344, 64108, 21369, 4645, 929, 191397);
insert into automoveis_por_residencia values (3, 108531, 84087, 23466, 2933, 0, 219018);
insert into automoveis_por_residencia values (4, 126792, 115670, 32254, 8897, 6673, 290287);
insert into automoveis_por_residencia values (5, 21718, 33539, 15669, 1374, 0, 72301);
insert into automoveis_por_residencia values (6, 95761, 72569, 14962, 1496, 748, 185537);
insert into automoveis_por_residencia values (7, 39977, 55353, 19769, 5711, 878, 121690);
insert into automoveis_por_residencia values (8, 47823, 48278, 14119, 1366, 455, 112042);
insert into automoveis_por_residencia values (9, 60283, 67185, 13805, 5061, 5061, 151397);
insert into automoveis_por_residencia values (10, 124589, 81081, 11865, 1977, 988, 220503);
insert into automoveis_por_residencia values (11, 58369, 46695, 10562, 555, 9450, 125632);
insert into automoveis_por_residencia values (12, 64302, 56460, 8625, 1176, 1960, 132525);
insert into automoveis_por_residencia values (13, 73943, 54948, 4748, 1356, 9497, 144494);
insert into automoveis_por_residencia values (14, 16144, 34470, 13526, 3272, 0, 67413);
insert into automoveis_por_residencia values (15, 17722, 44809, 25748, 11369, 0, 99649);
insert into automoveis_por_residencia values (16, 32060, 48982, 18256, 2671, 445, 102416);
insert into automoveis_por_residencia values (17, 71671, 60983, 18860, 3772, 2514, 157803);
insert into automoveis_por_residencia values (18, 138858, 89679, 27000, 3857, -0, 259396);
insert into automoveis_por_residencia values (19, 114974, 89823, 16168, 898, 0, 221864);
insert into automoveis_por_residencia values (20, 152466, 97764, 11638, 2327, 1163, 265362);
insert into automoveis_por_residencia values (21, 84589, 54481, 20788, 1433, 0, 161293);
insert into automoveis_por_residencia values (22, 42083, 42083, 18235, 2524, 561, 105488);
insert into automoveis_por_residencia values (23, 28039, 45348, 22847, 8308, 346, 104889);
insert into automoveis_por_residencia values (24, 73920, 71535, 7153, 2980, 596, 156186);
insert into automoveis_por_residencia values (25, 199863, 171713, 35187, 4222, -0, 410986);
insert into automoveis_por_residencia values (26, 210244, 154558, 29547, 4545, 4545, 403442);
insert into automoveis_por_residencia values (27, 201305, 190121, 57782, 1863, -0, 451072);
insert into automoveis_por_residencia values (28, 146941, 174493, 41327, 4591, 3061, 370415);
