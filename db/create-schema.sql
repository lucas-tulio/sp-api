...
drop table if exists viagens_produzidas_por_modo;
create table viagens_produzidas_por_modo (
  id int(11) primary key not null auto_increment,
  zona varchar(255),
  onibus int(11),
...
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Água Rasa, Belém, Moóca', 126823, 1189, 18713, 204108, 84651, 681, 77369, 21846, 15067, 1244, 126936, 523, 679150);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Sapopemba, São Lucas, Vila Prudente', 190451, 2712, 34255, 169977, 89363, 0, 43863, 5986, 25269, 8190, 360709, 2767, 933543);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Vila Formosa, Aricanduva, Tatuapé, Carrão', 177753, 4254, 31405, 264177, 102186, 531, 106275, 26002, 17695, 1047, 251941, 5091, 988358);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Vila Matilde, Cidade Líder, Artur Alvim', 103729, 3053, 20777, 157356, 73967, 480, 87074, 3236, 10768, 2544, 209063, 0, 672048);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Ponte Rasa, Ermelino Matarazzo, Penha, Cangaíba', 177954, 1929, 56137, 199785, 99754, 1594, 94199, 7667, 11865, 1063, 240119, 1063, 893129);
...
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('José Bonifácio, Itaquera, Parque do Carmo', 163030, 649, 57673, 128228, 68278, 0, 81958, 14081, 9462, 1757, 298575, 1298, 824988);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('São Mateus, Iguatemi, São Rafael', 176143, 3837, 42318, 106103, 52147, 480, 31035, 2918, 9667, 3782, 331075, 2398, 761905);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Lajeado, Guaianases, Cidade Tiradentes', 133875, 0, 34549, 82276, 31401, 0, 72469, 43170, 4451, 0, 340828, 0, 743019);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Pinheiros, Jardim Paulista', 199951, 2892, 6380, 209452, 62872, 14977, 185211, 18272, 15198, 3415, 189290, 0, 907911);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Moema, Itaim Bibi, Campo Belo', 260790, 4899, 18364, 370573, 114145, 19953, 84006, 40877, 42726, 4908, 233434, 896, 1195572);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Saúde, Vila Mariana', 145168, 544, 7093, 215371, 52021, 8065, 222047, 1599, 8349, 4102, 226772, 0, 891129);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Ipiranga, Cursino, Sacomã', 192028, 3511, 42689, 210051, 108706, 1516, 93896, 12153, 32857, 7625, 373851, 0, 1078882);
...
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Vila Andrade, Morumbi, Campo Limpo, Vila Sônia', 234988, 4036, 85109, 192111, 59780, 896, 40922, 8880, 36517, 5214, 316487, 3691, 988631);
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Jaguaré, Raposo Tavares, Rio Pequeno, Butantã', 186240, 5669, 38674, 160996, 65729, 260, 48889, 14304, 22967, 5722, 174297, 0, 723745);
...
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Santa Isabel, Arujá, Guarulhos', 650294, 28318, 107556, 473354, 194005, 0, 70000, 9302, 63054, 23380, 921627, 5895, 2546786);
...
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Diadema, São Bernardo do Campo', 607983, 57385, 152841, 617760, 309658, 7375, 40190, 11473, 65301, 0, 782017, 2373, 2654355);
...
insert into viagens_produzidas_por_modo (zona, onibus, transporte_fretado, transporte_escolar, dirigindo_automovel, passageiro_de_automovel, taxi, metro, trem, moto, bicicleta, a_pe, outros, total) values ('Cotia, Vargem Grande Paulista', 123943, 4710, 15116, 96249, 38192, 0, 7204, 1107, 10720, 2183, 177530, 904, 477860);
...
drop table if exists viagens_produzidas_por_tipo;
create table viagens_produzidas_por_tipo (
  id int(11) primary key not null auto_increment,
  zona varchar(255),
  coletivo int(11),
  individual int(11),
...
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Cambuci, Bom Retiro, República, Sé, Brás, Liberdade, Pari, Santa Cecília, Consolação, Bela Vista', 1259154, 669530, 1928684, 856524, 2785208);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('São Domingos, Jaraguá, Anhanguera, Perus, Pirituba, Jaguara', 411845, 327653, 739498, 368106, 1107604);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Casa Verde, Freguesia do Ó, Brasilândia, Limão, Cachoeirinha', 446473, 385758, 832231, 390252, 1222483);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Vila Maria, Vila Medeiros, Vila Guilherme, Jaçanã, Tremembé, Mandaqui, Santana, Tucuruvi', 797433, 673741, 1471174, 456721, 1927895);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Água Rasa, Belém, Moóca', 245940, 305030, 550970, 128180, 679150);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Sapopemba, São Lucas, Vila Prudente', 277267, 287376, 564643, 368899, 933542);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Vila Formosa, Aricanduva, Tatuapé, Carrão', 345689, 389680, 735369, 252988, 988357);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Vila Matilde, Cidade Líder, Artur Alvim', 217869, 242571, 460440, 211607, 672047);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Ponte Rasa, Ermelino Matarazzo, Penha, Cangaíba', 337886, 314061, 651947, 241182, 893129);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Vila Curuçá, Itaim Paulista, Jardim Helena, São Miguel Paulista, Vila Jacuí', 498434, 315319, 813753, 482060, 1295813);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('José Bonifácio, Itaquera, Parque do Carmo', 317391, 207266, 524657, 300332, 824989);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('São Mateus, Iguatemi, São Rafael', 256251, 170795, 427046, 334857, 761903);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Lajeado, Guaianases, Cidade Tiradentes', 284063, 118128, 402191, 340828, 743019);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Pinheiros, Jardim Paulista', 412706, 302499, 715205, 192705, 907910);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Moema, Itaim Bibi, Campo Belo', 408936, 548293, 957229, 238342, 1195571);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Saúde, Vila Mariana', 376451, 283806, 660257, 230874, 891131);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Ipiranga, Cursino, Sacomã', 344277, 353130, 697407, 381476, 1078883);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Pedreira, Santo Amaro, Cidade Ademar, Campo Grande, Jabaquara', 881927, 613761, 1495688, 494333, 1990021);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Cidade Dutra, Socorro, Grajaú, Parelheiros, Marsilac', 526024, 220796, 746820, 575447, 1322267);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Jardim Ângela, Capão Redondo, Jardim São Luís', 510376, 305156, 815532, 591874, 1407406);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Vila Andrade, Morumbi, Campo Limpo, Vila Sônia', 373935, 292995, 666930, 321701, 988631);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Jaguaré, Raposo Tavares, Rio Pequeno, Butantã', 293776, 249952, 543728, 180019, 723747);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Alto de Pinheiros, Lapa, Perdizes, Barra Funda, Vila Leopoldina', 525505, 486019, 1011524, 201218, 1212742);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Caieiras, Cajamar, Francisco Morato, Franco da Rocha, Mairiporã', 308091, 231945, 540036, 302709, 842745);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Santa Isabel, Arujá, Guarulhos', 865470, 736308, 1601778, 945007, 2546785);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Poá, Salesópolis, Biritiba-Mirim, Suzano, Ferraz de Vasconcelos, Guararema, Itaquaquecetuba, Mogi das Cruzes', 737247, 707028, 1444275, 1139881, 2584156);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('São Caetano do Sul, Mauá, Ribeirão Pires, Rio Grande da Serra, Santo André', 1084578, 1361502, 2446080, 968131, 3414211);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Diadema, São Bernardo do Campo', 869872, 1002467, 1872339, 782017, 2654356);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Juquitiba, São Lourenço da Serra, Taboão da Serra, Embu das Artes, Embu-Guaçu, Itapecerica da Serra', 438065, 345637, 783702, 513831, 1297533);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Cotia, Vargem Grande Paulista', 152080, 146065, 298145, 179713, 477858);
insert into viagens_produzidas_por_tipo (zona, coletivo, individual, modo_motorizado, modo_nao_motorizado, total) values ('Carapicuíba, Itapevi, Jandira, Osasco, Pirapora do Bom Jesus, Santana de Parnaíba, Barueri', 1338963, 1001249, 2340212, 1004162, 3344374);
...
drop table if exists populacao_por_renda_mensal;
create table populacao_por_renda_mensal (
  id int(11) primary key not null auto_increment,
  zona varchar(255),
  ate_1244 int(11),
  1244_a_2488 int(11),
...
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Cambuci, Bom Retiro, República, Sé, Brás, Liberdade, Pari, Santa Cecília, Consolação, Bela Vista', 47483, 141074, 163095, 97031, 37849, 486534);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('São Domingos, Jaraguá, Anhanguera, Perus, Pirituba, Jaguara', 108520, 188286, 226315, 66781, 32463, 622367);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Casa Verde, Freguesia do Ó, Brasilândia, Limão, Cachoeirinha', 123051, 259107, 234097, 88036, 16006, 720300);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Vila Maria, Vila Medeiros, Vila Guilherme, Jaçanã, Tremembé, Mandaqui, Santana, Tucuruvi', 108904, 223728, 348022, 202421, 35512, 918589);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Água Rasa, Belém, Moóca', 18050, 34063, 66963, 56773, 31734, 207586);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Sapopemba, São Lucas, Vila Prudente', 133009, 166261, 156208, 49491, 27839, 532810);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Vila Formosa, Aricanduva, Tatuapé, Carrão', 28207, 89099, 145962, 74324, 22386, 359979);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Vila Matilde, Cidade Líder, Artur Alvim', 50067, 97958, 123645, 58339, 7836, 337849);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Ponte Rasa, Ermelino Matarazzo, Penha, Cangaíba', 64113, 117769, 180518, 90486, 20007, 472895);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Vila Curuçá, Itaim Paulista, Jardim Helena, São Miguel Paulista, Vila Jacuí', 191218, 309228, 206516, 32780, 5463, 745207);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('José Bonifácio, Itaquera, Parque do Carmo', 63293, 149905, 139356, 45526, 4441, 402523);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('São Mateus, Iguatemi, São Rafael', 101777, 183445, 116141, 29548, 4103, 435017);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Lajeado, Guaianases, Cidade Tiradentes', 110617, 190883, 155134, 31701, 0, 488336);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Pinheiros, Jardim Paulista', 4665, 10886, 43324, 47545, 48434, 154856);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Moema, Itaim Bibi, Campo Belo', 4216, 14595, 48003, 82708, 94708, 244232);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Saúde, Vila Mariana', 15347, 33021, 89762, 82786, 41858, 262776);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Ipiranga, Cursino, Sacomã', 79103, 154317, 148481, 79752, 8429, 470084);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Pedreira, Santo Amaro, Cidade Ademar, Campo Grande, Jabaquara', 112717, 273004, 287482, 115820, 29989, 819014);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Cidade Dutra, Socorro, Grajaú, Parelheiros, Marsilac', 123009, 301000, 261861, 40071, 20501, 746444);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Jardim Ângela, Capão Redondo, Jardim São Luís', 203271, 322843, 269036, 55002, 3587, 853741);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Vila Andrade, Morumbi, Campo Limpo, Vila Sônia', 79682, 198439, 145573, 60527, 26816, 511038);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Jaguaré, Raposo Tavares, Rio Pequeno, Butantã', 40599, 92083, 113853, 63252, 17063, 326852);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Alto de Pinheiros, Lapa, Perdizes, Barra Funda, Vila Leopoldina', 16091, 49348, 80817, 84393, 46130, 276781);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Caieiras, Cajamar, Francisco Morato, Franco da Rocha, Mairiporã', 107751, 190298, 202270, 29615, 6301, 536237);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Santa Isabel, Arujá, Guarulhos', 228610, 562179, 422713, 162471, 4313, 1380287);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Poá, Salesópolis, Biritiba-Mirim, Suzano, Ferraz de Vasconcelos, Guararema, Itaquaquecetuba, Mogi das Cruzes', 365400, 467569, 403864, 90148, 25241, 1352224);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('São Caetano do Sul, Mauá, Ribeirão Pires, Rio Grande da Serra, Santo André', 225325, 529820, 403962, 213146, 44659, 1416914);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Diadema, São Bernardo do Campo', 184549, 444810, 399067, 121455, 17350, 1167233);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Juquitiba, São Lourenço da Serra, Taboão da Serra, Embu das Artes, Embu-Guaçu, Itapecerica da Serra', 138936, 275777, 255530, 85176, 8378, 763799);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Cotia, Vargem Grande Paulista', 30353, 112541, 86390, 16344, 10740, 256370);
insert into populacao_por_renda_mensal (zona, ate_1244, 1244_a_2488, 2488_a_4976, 4976_a_9330, mais_de_9330, total) values ('Carapicuíba, Itapevi, Jandira, Osasco, Pirapora do Bom Jesus, Santana de Parnaíba, Barueri', 392186, 687899, 453007, 157294, 52431, 1742819);
...
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Cambuci, Bom Retiro, República, Sé, Brás, Liberdade, Pari, Santa Cecília, Consolação, Bela Vista', 796468814, 3941, 1637, 3000);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('São Domingos, Jaraguá, Anhanguera, Perus, Pirituba, Jaguara', 589592671, 3080, 947, 2204);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Casa Verde, Freguesia do Ó, Brasilândia, Limão, Cachoeirinha', 593831507, 2711, 824, 2110);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Vila Maria, Vila Medeiros, Vila Guilherme, Jaçanã, Tremembé, Mandaqui, Santana, Tucuruvi', 1006017073, 3465, 1095, 2800);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Água Rasa, Belém, Moóca', 363631673, 5029, 1751, 3987);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Sapopemba, São Lucas, Vila Prudente', 489535836, 2638, 918, 1900);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Vila Formosa, Aricanduva, Tatuapé, Carrão', 427467013, 3512, 1187, 2845);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Vila Matilde, Cidade Líder, Artur Alvim', 350988310, 3132, 1038, 2441);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Ponte Rasa, Ermelino Matarazzo, Penha, Cangaíba', 475970063, 3143, 1006, 2634);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Vila Curuçá, Itaim Paulista, Jardim Helena, São Miguel Paulista, Vila Jacuí', 457917675, 2076, 614, 1840);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('José Bonifácio, Itaquera, Parque do Carmo', 322834242, 2569, 802, 2173);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('São Mateus, Iguatemi, São Rafael', 286603604, 2162, 658, 1820);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Lajeado, Guaianases, Cidade Tiradentes', 317185962, 2195, 649, 2000);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Pinheiros, Jardim Paulista', 572983560, 8499, 3700, 5587);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Moema, Itaim Bibi, Campo Belo', 912028698, 9152, 3734, 6613);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Saúde, Vila Mariana', 554847815, 5417, 2111, 4000);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Ipiranga, Cursino, Sacomã', 501319951, 3176, 1066, 2209);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Pedreira, Santo Amaro, Cidade Ademar, Campo Grande, Jabaquara', 780248540, 3007, 952, 2209);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Cidade Dutra, Socorro, Grajaú, Parelheiros, Marsilac', 582844236, 2627, 780, 1870);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Jardim Ângela, Capão Redondo, Jardim São Luís', 587124918, 2212, 687, 1900);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Vila Andrade, Morumbi, Campo Limpo, Vila Sônia', 494430309, 3065, 967, 2209);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Jaguaré, Raposo Tavares, Rio Pequeno, Butantã', 379746799, 3599, 1161, 2845);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Alto de Pinheiros, Lapa, Perdizes, Barra Funda, Vila Leopoldina', 582298748, 5551, 2103, 4000);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Caieiras, Cajamar, Francisco Morato, Franco da Rocha, Mairiporã', 373831519, 2393, 697, 2000);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Santa Isabel, Arujá, Guarulhos', 1001045396, 2435, 725, 2030);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Poá, Salesópolis, Biritiba-Mirim, Suzano, Ferraz de Vasconcelos, Guararema, Itaquaquecetuba, Mogi das Cruzes', 891512733, 2209, 659, 1800);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('São Caetano do Sul, Mauá, Ribeirão Pires, Rio Grande da Serra, Santo André', 1300780621, 2883, 918, 2111);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Diadema, São Bernardo do Campo', 1013654206, 2736, 868, 2200);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Juquitiba, São Lourenço da Serra, Taboão da Serra, Embu das Artes, Embu-Guaçu, Itapecerica da Serra', 575527457, 2539, 753, 2044);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Cotia, Vargem Grande Paulista', 216238162, 2843, 843, 2400);
insert into renda (zona, renda_total, renda_media_familiar, renda_per_capita, renda_mediana_familiar) values ('Carapicuíba, Itapevi, Jandira, Osasco, Pirapora do Bom Jesus, Santana de Parnaíba, Barueri', 1388590540, 2667, 796, 2000);

drop table if exists familias_por_numero_de_automoveis;
create table familias_por_numero_de_automoveis (
  id int(11) primary key not null auto_increment,
  zona varchar(255),
...
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Cambuci, Bom Retiro, República, Sé, Brás, Liberdade, Pari, Santa Cecília, Consolação, Bela Vista', 110563, 78156, 11437, 635, 1270, 202064);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('São Domingos, Jaraguá, Anhanguera, Perus, Pirituba, Jaguara', 100344, 64108, 21369, 4645, 929, 191397);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Casa Verde, Freguesia do Ó, Brasilândia, Limão, Cachoeirinha', 108531, 84087, 23466, 2933, 0, 219018);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Vila Maria, Vila Medeiros, Vila Guilherme, Jaçanã, Tremembé, Mandaqui, Santana, Tucuruvi', 126792, 115670, 32254, 8897, 6673, 290287);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Água Rasa, Belém, Moóca', 21718, 33539, 15669, 1374, 0, 72301);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Sapopemba, São Lucas, Vila Prudente', 95761, 72569, 14962, 1496, 748, 185537);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Vila Formosa, Aricanduva, Tatuapé, Carrão', 39977, 55353, 19769, 5711, 878, 121690);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Vila Matilde, Cidade Líder, Artur Alvim', 47823, 48278, 14119, 1366, 455, 112042);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Ponte Rasa, Ermelino Matarazzo, Penha, Cangaíba', 60283, 67185, 13805, 5061, 5061, 151397);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Vila Curuçá, Itaim Paulista, Jardim Helena, São Miguel Paulista, Vila Jacuí', 124589, 81081, 11865, 1977, 988, 220503);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('José Bonifácio, Itaquera, Parque do Carmo', 58369, 46695, 10562, 555, 9450, 125632);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('São Mateus, Iguatemi, São Rafael', 64302, 56460, 8625, 1176, 1960, 132525);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Lajeado, Guaianases, Cidade Tiradentes', 73943, 54948, 4748, 1356, 9497, 144494);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Pinheiros, Jardim Paulista', 16144, 34470, 13526, 3272, 0, 67413);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Moema, Itaim Bibi, Campo Belo', 17722, 44809, 25748, 11369, 0, 99649);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Saúde, Vila Mariana', 32060, 48982, 18256, 2671, 445, 102416);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Ipiranga, Cursino, Sacomã', 71671, 60983, 18860, 3772, 2514, 157803);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Pedreira, Santo Amaro, Cidade Ademar, Campo Grande, Jabaquara', 138858, 89679, 27000, 3857, -0, 259396);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Cidade Dutra, Socorro, Grajaú, Parelheiros, Marsilac', 114974, 89823, 16168, 898, 0, 221864);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Jardim Ângela, Capão Redondo, Jardim São Luís', 152466, 97764, 11638, 2327, 1163, 265362);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Vila Andrade, Morumbi, Campo Limpo, Vila Sônia', 84589, 54481, 20788, 1433, 0, 161293);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Jaguaré, Raposo Tavares, Rio Pequeno, Butantã', 42083, 42083, 18235, 2524, 561, 105488);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Alto de Pinheiros, Lapa, Perdizes, Barra Funda, Vila Leopoldina', 28039, 45348, 22847, 8308, 346, 104889);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Caieiras, Cajamar, Francisco Morato, Franco da Rocha, Mairiporã', 73920, 71535, 7153, 2980, 596, 156186);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Santa Isabel, Arujá, Guarulhos', 199863, 171713, 35187, 4222, -0, 410986);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Poá, Salesópolis, Biritiba-Mirim, Suzano, Ferraz de Vasconcelos, Guararema, Itaquaquecetuba, Mogi das Cruzes', 210244, 154558, 29547, 4545, 4545, 403442);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('São Caetano do Sul, Mauá, Ribeirão Pires, Rio Grande da Serra, Santo André', 201305, 190121, 57782, 1863, -0, 451072);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Diadema, São Bernardo do Campo', 146941, 174493, 41327, 4591, 3061, 370415);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Juquitiba, São Lourenço da Serra, Taboão da Serra, Embu das Artes, Embu-Guaçu, Itapecerica da Serra', 100584, 93399, 26778, 3918, 1959, 226641);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Cotia, Vargem Grande Paulista', 29391, 36389, 8397, 1399, 466, 76045);
insert into familias_por_numero_de_automoveis (zona, nenhum_automovel, 1_automovel, 2_automoveis, 3_automoveis_ou_mais, nao_declarado, total_de_familias) values ('Carapicuíba, Itapevi, Jandira, Osasco, Pirapora do Bom Jesus, Santana de Parnaíba, Barueri', 247328, 227382, 35902, 7978, 1994, 520586);

drop table if exists populacao_trabalhadora_por_vinculo;
create table populacao_trabalhadora_por_vinculo (
  id int(11) primary key not null auto_increment,
  zona varchar(255),
  assalariado_com_carteira int(11),
  assalariado_sem_carteira int(11),
...
insert into populacao_trabalhadora_por_vinculo (zona, assalariado_com_carteira, assalariado_sem_carteira, funcionario_publico, autonomo, empregador, profissional_liberal, dono_de_negocio_familiar, trabalhador_familiar, total_da_populacao_que_trabalha) values ('Saúde, Vila Mariana', 70693, 10231, 12092, 37672, 5581, 4185, 3720, 0, 144177);
